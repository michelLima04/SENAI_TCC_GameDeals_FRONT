  ...
  const handleSubmit = async (e) => {
    ...
    if (url && isValidUrl(url)) {
      try {
        ...
        setMessage(
          error.response.data.mensagem || "Erro ao cadastrar promoção."
        );
      }
    } else {
          ...
          <div className="product-details-card">
            ...
            <div className="details-content">
              <div className="image-display-group">
                ...
                <img src={productDetails.imageUrl} className="product-image" />
              </div>
              ...
              <div className="detail-input-group">
                <label htmlFor="site" className="detail-label">
                  Site
                </label>
                <input
                  type="text"
              ...
              <div className="detail-input-group">
                <label htmlFor="title" className="detail-label">
                  Título
                </label>
                <input
                  type="text"
